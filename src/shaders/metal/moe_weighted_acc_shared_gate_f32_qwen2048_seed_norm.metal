...
// a separate hidden row. The layer-0 SSM prefill precompute already materializes
// post-SSM hidden rows; consume that row directly instead of copying it first.
kernel void main0(
    ...
    device const float* base_hidden [[buffer(9)]],
