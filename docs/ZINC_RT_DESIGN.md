...
| `ZINC_RT_DIRECT_SSM_Q8_ROW_RANGE_MAX_SUCCESSES` | 1 | Per tracked decode slice cap on consumed direct SSM alpha/beta row-range successes; set `0` to disable the serial M1 SSM row-range verifier |
